...
const ContactModal = () => {
  ...
  return (
    <>
      <ModalButton modalid={id} modaltype="open" className="btn btn-primary">
        Contact us -&gt;
      </ModalButton>
      <Modal id={id}>
        <ModalBox className=" h-auto text-base-content">
          ...
          <form className=" flex flex-col w-auto" onSubmit={handleMessageSend}>
            {loggedIn && user ? (
              <>
                <p>
              ...
              <label
                className="input input-bordered flex items-center my-2 gap-2"
                htmlFor="email"
              >
                <svg
