...
const SpellRollMaker = ({
  ...
  return (
    <div className="flex flex-row w-full bg-base-100 rounded-xl p-2">
      <label className="form-control w-1/4 px-1" htmlFor="amount">
        <div className="label">
          ...
          <div className="modal-box">
            ...
            <form className="flex items-center flex-col">
              <div className="flex flex-col w-full bg-base-300 rounded-xl p-4 items-center">
                ...
                <label className="form-control w-full max-w-xs" htmlFor="notes">
                  <div className="label">
                ...
                <label className="form-control w-full max-w-xs" htmlFor="range">
                  <div className="label">
                ...
                <div className="grid grid-cols-3 justify-center items-center mt-2 mb-4 whitespace-nowrap overflow-hidden text-ellipsis">
                  <label
                    className="form-control w-full max-w-xs items-center col-span-1"
                    htmlFor="prepared"
                  >
                    <div className="label">
                  ...
                  <label
                    className="form-control w-full max-w-xs col-span-1 items-center"
