...
const SelectSubclass = () => {
  ...
  return (
    <>
      <Head>
        <title>{className.toCapitalCase()} Subclasses</title>
        <meta
          name="description"
          content={`View all ${className.toCapitalCase()} subclasses`}
        />
      </Head>
      <main className="p-8">
        ...
        <p className="italic">
          ...
          official content and should be reviewed by your Dungeon Master before
