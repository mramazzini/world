// 'use client';
// import { combatRatingToProficiency } from '@/Utility/combatRatingToProficiency';
...
const CreaturePage = ({ creature }: Props) => {
  ...
  //           </p>
  //         )}
  //         <label className="label" htmlFor="showAllSkills">
  //           Show All Skills
  //         </label>
  //         <input
  //           type="checkbox"
  ...
  //     <CommentSection model={AssociatedModel.CREATURE} id={creature.id} />
    */}
      ...
      <main className="flex flex-col gap-4">
        <div>Creatures pages are temporarily down</div>
      </main>
    </>
  );
};
