    ...
    <main className="p-4 md:p-8">
        ...
        <div className="flex flex-col md:w-4/5">
          ...
          <p className="mb-4">
            {item.types.map((type, index) => (
              <span key={index} className="badge badge-accent font-bold mr-1">
                {type.toCapitalCase().replaceAll('_', ' ')}
              </span>
            ))}
            {item.rarity == Rarity.COMMON ? (
              <span className="badge badge-primary font-bold mr-1">Common</span>
            ) : item.rarity == Rarity.UNCOMMON ? (
              <span className="badge badge-success font-bold mr-1">
                Uncommon
              </span>
            ) : item.rarity == Rarity.RARE ? (
              <span className="badge badge-warning font-bold mr-1">Rare</span>
          ...
          <div className="bg-base-300 rounded-xl p-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="bg-base-200 rounded-xl p-4 max-w-1/3">
                ...
                <p>
                  <P>
                    An arcane focus is a special item designed to channel the
                    power of arcane spells.
                  </P>
                </p>
                <br />
                <p>
                  <P>
                    ...
                    components specified for a spell. But if a cost is indicated
                    for a component, a character must have that specific
              ...
              <div className="bg-base-200 rounded-xl p-4 max-w-1/3">
                ...
                <p>
                  <P>
                    ...
                    might be an amulet depicting a symbol representing a deity,
                    the same symbol carefully engraved or inlaid as an emblem on
              ...
              <div className="bg-base-200 rounded-xl p-4 max-w-1/3">
                ...
                <p>
                  <P>
                    ...
                    wand or scepter made of yew or another special wood, a staff
                    drawn whole out of a living tree, or a totem object
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="bg-base-200 rounded-xl p-4 max-w-1/3">
                ...
                <p className="p-4 bg-base-300 rounded-t-xl">
                  <P>
                    When you acquire this Equipment Pack, you gain the following
                    items.
                  </P>
                </p>
                    ...
                    json={[
                      {
                        '': {
                          ...
                          headersLength: [15, 85],
                          data: [
                            ...item.EquipmentPack.itemsQuantity.map((item) => {
                              return {
                                Item: `^${item.item}{}^`,
              ...
              <div className="bg-base-200 rounded-xl p-4 max-w-1/3">
                ...
                <ul className="list-disc ">
                  ...
                  <li className="ml-4">
                    ...
                    <P>
                      Only those proficient in the armor’s use know how to wear
                      it effectively. Your class gives you proficiency with
                      certain types of armor. If you wear armor that you lack
                      proficiency with, you have disadvantage on any ability
                      check, saving throw, or Attack roll that involves Strength
              ...
              <div className="bg-base-200 rounded-xl p-4 max-w-1/3">
                ...
                <p>
                  <P>
                    ...
                    a mystical cipher. If the spell is on your class&apos;s
                    spell list, you can read the scroll and cast its spell
                    without providing any material components. Otherwise, the
                    scroll is unintelligible. Casting the spell by reading the
                    scroll requires the spell&apos;s normal casting time. Once
                    the spell is cast, the words on the scroll fade, and it
                ...
                <p>
                  <P>
                    ...
                    from a spell scroll, the copier must succeed on an
                    Intelligence (Arcana) check with a DC equal to 10 + the
                    spell&apos;s level. If the check succeeds, the spell is
                    successfully copied. Whether the check succeeds or fails,
              ...
              {item.ItemWeaponData.Weapon.SpecialProperties.length > 0 && (
                <>
                  ...
                  {item.ItemWeaponData.Weapon.SpecialProperties && (
                    <FeatureList
                      features={item.ItemWeaponData.Weapon.SpecialProperties}
                    />
                  )}
                  <div className="divider m-0"></div>
                </>
      ...
      {item.types.includes(ItemTypes.CURRENCY) && (
        <>
          <div className="bg-base-300 rounded-xl p-4">
            <h2 className="pb-0">
              Currency <Info tooltip="This item is classified as currency." />
            </h2>
            <div className="divider "></div>
            <div className="grid grid-cols-1 gap-4">
              <div className="bg-base-200 rounded-xl p-4 max-w-1/3">
                ...
                <ul className="list-disc ">
                  <li className="ml-4">
                    <span className="font-bold">Value:</span>{' '}
                    <P>
                      The most basic type of treasure is money, including copper
                      pieces (cp), silver pieces (sp), electrum pieces (ep),
                      gold pieces (gp), and platinum pieces (pp). Fifty coins of
                      any type weigh 1 pound.
                    </P>
                  </li>
                  <div className="divider m-0"></div>
                  <li className="ml-4">
