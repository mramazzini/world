...
const cantrips: Prisma.SpellCreateManyInput[] = [
  {
    name: "Acid Splash",
    level: 0,
    ...
    extendedTable: [
      {
        "": {
          ...
          data: [
            ...
            {
              Effect: "You cause harmless tremors in the ground for 1 minute.",
            },
            {
              Effect:
            ...
            {
              Effect: "You alter the appearance of your eyes for 1 minute.",
            },
          ],
        },
      },
