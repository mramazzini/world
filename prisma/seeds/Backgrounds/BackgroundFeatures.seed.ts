...
export const backgroundFeatureIds = {
...
const BackgroundFeatures: Prisma.FeatureCreateManyInput[] = [
  //acolyte
  {
    id: backgroundFeatureIds.shelterOfTheFaithful,
  ...
  //anthropologist
  {
    id: backgroundFeatureIds.culturalChameleon,
  ...
  {
    id: backgroundFeatureIds.adeptLinguist,
    backgroundId: ids.anthropologist,
    name: 'Adept Linguist',
    unimplemented: false,
    description:
  ...
  //cityWatch
  {
    id: backgroundFeatureIds.watchersEyeCityWatch,
    name: "Watcher's Eye",
    unimplemented: false,
    description:
  ...
  {
    id: backgroundFeatureIds.heartOfDarkness,
    backgroundId: ids.hauntedOne,
    unimplemented: false,
  ...
  {
    id: backgroundFeatureIds.lifeOfSeclusion,
  ...
  {
    id: backgroundFeatureIds.discovery,
    backgroundId: ids.hermit,
    name: 'Discovery',
    unimplemented: false,
    description:
  ...
  // },
  {
    id: backgroundFeatureIds.watchersEye,
  ...
  // },
  {
    id: backgroundFeatureIds.knightlyOrdersOfFaerun,
    unimplemented: false,
  ...
  {
    id: backgroundFeatureIds.knightlyRegard,
    unimplemented: false,
    backgroundId: ids.knightOfTheOrder,
  ...
  // },
  {
    id: backgroundFeatureIds.mercenariesOfTheNorth,
  ...
  {
    id: backgroundFeatureIds.mercenaryLife,
    backgroundId: ids.mercenaryVeteran,
    unimplemented: false,
    name: 'Mercenary Life',
    description:
  ...
  {
    id: backgroundFeatureIds.origin,
  ...
  {
    id: backgroundFeatureIds.wanderer,
    unimplemented: false,
    backgroundId: ids.outlander,
    name: 'Wanderer',
    description:
  ...
  // },
  {
    id: backgroundFeatureIds.runeStyles,
  ...
  {
    id: backgroundFeatureIds.runeCarver,
    backgroundId: ids.runeCarver,
    unimplemented: false,
    name: 'Rune Shaper',
  ...
  // },
  {
    id: backgroundFeatureIds.shipsPassage,
    name: "Ship's Passage",
    unimplemented: false,
    description:
  ...
  {
    id: backgroundFeatureIds.illPatchIt,
    unimplemented: false,
    name: "I'll patch it!",
    description:
  ...
  {
    id: backgroundFeatureIds.lifeAtSea,
    backgroundId: ids.sailor,
    unimplemented: false,
    name: 'Life at Sea',
    description:
  ...
  // },
  {
    id: backgroundFeatureIds.specialty,
  ...
  {
    id: backgroundFeatureIds.militaryRank,
    unimplemented: false,
    backgroundId: ids.soldier,
    name: 'Military Rank',
    description:
  ...
  // },
  {
    id: backgroundFeatureIds.neverTellMeTheOdds,
  ...
  // },
  {
    id: backgroundFeatureIds.insideInformant,
