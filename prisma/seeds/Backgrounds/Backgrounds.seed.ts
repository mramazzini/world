...
const i = (id: string | number, str: string) => `^${id}{${str}}^`;
...
const Backgrounds: Prisma.BackgroundCreateManyInput[] = [
  {
    ...
    source: src.phb,
    freeSkillProficiencies: [Skill.INSIGHT, Skill.RELIGION],
  ...
  // },
  {
    ...
    freeSkillProficiencies: [Skill.ATHLETICS, Skill.INSIGHT],
    languageProficiencyDescription:
      'You are proficient in two languages of your choice.',
    equipmentDescription: [
      `A ${i(
  ...
  },
  {
    ...
    freeSkillProficiencies: [Skill.MEDICINE, Skill.RELIGION],
  ...
  // },
  {
    ...
    freeSkillProficiencies: [Skill.INVESTIGATION, Skill.INSIGHT],
    languageProficiencyDescription:
      'You are proficient in two languages of your choice.',
    equipmentDescription: [
      `A ${i(
  ...
  // },
  {
    ...
    freeSkillProficiencies: [Skill.PERSUASION],
  ...
  // },
  {
    ...
    freeSkillProficiencies: [Skill.ATHLETICS, Skill.PERSUASION],
    toolProficiencyDescription:
      'You are proficient with one type of gaming set and land vehicles.',

    freeToolProficiencyIds: [toolIds.landVehicles],
    equipmentDescription: [
  ...
  // },
  {
    ...
    freeSkillProficiencies: [Skill.HISTORY, Skill.PERCEPTION],

    languageProficiencyDescription: 'You are proficient in Giant.',
    freeLanguageProficiencies: [Language.GIANT],
    equipmentDescription: [
  ...
  // },
  {
    ...
    skillProficiencyDescription:
      'You are proficient in Athletics and Perception.',
    freeSkillProficiencies: [Skill.ATHLETICS, Skill.PERCEPTION],
    toolProficiencyDescription:
      "You are proficient with navigator's tools and water vehicles.",
    freeToolProficiencyIds: [toolIds.navigatorsTools, toolIds.waterVehicle],
  ...
  // },
  {
    ...
    freeSkillProficiencies: [Skill.ATHLETICS, Skill.INTIMIDATION],
    toolProficiencyDescription:
      'You are proficient with one type of gaming set and land vehicles.',
    freeToolProficiencyIds: [toolIds.landVehicles],
  ...
  // },
  {
    ...
    freeSkillProficiencies: [Skill.HISTORY, Skill.INVESTIGATION],
    toolProficiencyDescription:
      "You are proficient with one type of artisan's tools.",
    languageProficiencyDescription:
      'You are proficient in one language of your choice.',
