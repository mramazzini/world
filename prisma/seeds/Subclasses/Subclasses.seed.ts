...
const SubClasses: Prisma.SubClassCreateManyInput[] = [
  ...
  //rogue
  {
    ...
    //   "You know three 1st-level wizard spells of your choice, two of which you must choose from the enchantment and illusion spells on the wizard spell list.\n\nThe Spells Known column of the Arcane Trickster Spellcasting table shows when you learn more wizard spells of 1st level or higher. Each of these spells must be an enchantment or illusion spell of your choice, and must be of a level for which you have spell slots. For instance, when you reach 7th level in this class, you can learn one new spell of 1st or 2nd level.\n\nThe spells you learn at 8th, 14th, and 20th level can come from any school of magic.\n\nWhenever you gain a level in this class, you can replace one of the wizard spells you know with another spell of your choice from the wizard spell list. The new spell must be of a level for which you have spell slots, and it must be an enchantment or illusion spell, unless you're replacing the spell you gained at 3rd, 8th, 14th, or 20th level from any school of magic.",
    // prepareSpellInfo:
    //   "The Arcane Trickster Spellcasting table shows how many spell slots you have to cast your wizard spells of 1st level and highery. To cast one of these spells, you must expend a slot of the spell's level or higher. You regain all expended spell slots when you finish a long rest.",
  ...
  // warlock
  {
    ...
    source: src.phb,
    flavorText:
      "Warlocks with the Archfey patron have a lord or lady of the fey as their patron, a creature of legend who holds secrets that were forgotten before the mortal races were born.",
  },
  {
    name: "The Celestial",
    description:
    ...
    source: src.xanathar,
    flavorText:
      "Warlocks with the Celestial patron have bound themselves to a powerful being of the Upper Planes, allowing them to experience the holy light that illuminates the multiverse.",
  },
  {
    name: "The Fathomless",
    description:
    ...
    source: src.tasha,
    flavorText:
      "Warlocks with the Fathomless patron have plunged into a pact with the deeps, drawing on the thalassic power of the ocean.",
  },
  {
    name: "The Fiend",
    description:
    ...
    source: src.phb,
    flavorText:
      "Warlocks with the Fiend patron have made a pact with a fiend from the lower planes of existence, a being whose aims are evil.",
  },
  {
    name: "The Genie",
    description:
    ...
    source: src.tasha,
    flavorText:
      "Warlocks with the Genie patron have made a pact with one of the rarest kinds of genie, a noble genie.",
  },
  {
    ...
    source: src.phb,
    flavorText:
      "Warlocks with the Great Old One patron have made a pact with a mysterious entity whose nature is utterly foreign to the fabric of reality.",
  },
  {
    name: "The Hexblade",
    description:
    ...
    source: src.xanathar,
    flavorText:
      "Warlocks with the Hexblade patron have made a pact with a mysterious entity from the Shadowfell, a force that manifests in sentient magic weapons carved from the stuff of shadow.",
  },
  {
    name: "The Undead",
    description:
    ...
    source: src.tasha,
    flavorText:
      "Warlocks with the Undead patron have made a pact with a deathless being, a creature that defies the cycle and life and death.",
  },
  {
    name: "The Undying",
    description:
    ...
    source: src.sword,
    flavorText:
      "Warlocks with the Undying patron have made a pact with a patron who has unlocked the secrets of everlasting life.",
  },
];
