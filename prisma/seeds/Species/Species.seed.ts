...
import { Prisma, Size, CreatureType, Language, Ability } from '@prisma/client';
...
const Species: Prisma.SpeciesCreateManyInput[] = [
  {
    ...
    freeLanguages: [Language.DRACONIC, Language.COMMON],
  ...
  },
  {
    ...
    freeLanguages: [Language.DWARVISH, Language.COMMON],
  ...
  },
  {
    ...
    freeLanguages: [Language.ELVISH, Language.COMMON],
  ...
  },
  {
    ...
    freeLanguages: [Language.GNOMISH, Language.COMMON],
  ...
  },
  {
    ...
    freeLanguages: [Language.ORC, Language.COMMON],
    languageDescription:
  ...
  },
  {
    ...
    freeLanguages: [Language.HALFLING, Language.COMMON],
  ...
  },
  {
    ...
    freeLanguages: [Language.INFERNAL, Language.COMMON],
  ...
  },
  {
    ...
    freeLanguages: [Language.CELESTIAL, Language.COMMON],
    creatureType: CreatureType.HUMANOID,
  },
  // {
  //   id: '13',
  ...
  //     [Language.GNOMISH, Language.COMMON],
  //   },
  // },
  // {
  //   id: '17',
  ...
  //     [Language.DWARVISH, Language.COMMON],
  //   },
  //   toolProficiencies: {
  //     choices: [
  //       {
  ...
  //     [Language.ELVISH, Language.COMMON],
  //   },
  //   skillProficiencies: {
  //     [Skill.PERCEPTION],
  //   },
  ...
  //     [Language.COMMON, Language.ELVISH, Language.GIANT],
  //   },
  //   abilityScoreDescription:
  ...
  },
  {
    ...
    freeLanguages: [Language.COMMON, Language.PRIMORDIAL],
    creatureType: CreatureType.HUMANOID,
  },
  // {
  //   id: '27',
  ...
  //     [Language.COMMON, Language.AURAN],
  //   },
  //   creatureType: CreatureType.HUMANOID,
  // },
  // {
  ...
  //     [Language.COMMON, Language.AQUAN],
  //   },
  //   creatureType: CreatureType.HUMANOID,
  // },
  // {
  ...
  //     [Language.COMMON, Language.SYLVAN],
  //   },
  //   skillProficiencyDescription:
  //     'You have proficiency in the Performance and Stealth skills.',
  //   skillProficiencies: {
  //     [Skill.PERFORMANCE, Skill.STEALTH],
  //   },
  //   toolProficiencies: {
  //     choices: [
  //       {
  ...
  //     [Language.COMMON, Language.ELVISH, Language.AQUAN],
  //   },
  //   alignment: 'N/A',
  //   weaponProficiencies: {
  //     [
  ...
  //     [Language.COMMON, Language.GOBLIN],
  //     choices: [
  //       {
  ...
  //     [Language.COMMON, Language.QUORI],
  //     choices: [
  //       {
  //         options: Object.values(Language).filter(
  ...
  //     [Language.COMMON, Language.MINOTAUR],
  //   },
  //   creatureType: CreatureType.HUMANOID,
  // },
  // {
  ...
  //     [Language.COMMON, Language.ABYSSAL, Language.DRACONIC],
  //   },
  //   creatureType: CreatureType.HUMANOID,
  // },
  // {
  ...
  //     [Language.COMMON, Language.KHENRA],
  //   },
  //   creatureType: CreatureType.HUMANOID,
  // },
  // {
  ...
  //     [Language.COMMON, Language.MERFOLK],
  //     choices: [
  //       {
  //         options: Object.values(Language).filter(
  ...
  //     [Language.COMMON, Language.SIREN],
  //   },
  // },
  // {
  //   id: '118',
  ...
  //     [Language.COMMON, Language.VAMPIRE],
  //   },
  //   creatureType: CreatureType.HUMANOID,
  // },
  // {
